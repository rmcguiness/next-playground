        ...
        <div className="mt-6">
            <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-background text-foreground-1">Or continue with</span>
                </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
                ...
                <form action={signInWithOAuth.bind(null, 'github')}>
                    <button
                        type="submit"
                        className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-background text-sm font-medium text-foreground hover:bg-gray-50 transition-colors"
