...
export default function TestPage() {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: ["Pages Router", "App Router", "Dynamic Router", "API Routes"],
    ...
    },
    {
      id: 6,
      question:
        "Which of the following is a valid way to create a Server Component in Next.js?",
      options: [
    ...
    },
    {
      id: 7,
      question:
        "What is the purpose of the 'revalidatePath' function in Next.js?",
      options: [
    ...
    },
    {
      id: 8,
      question:
        "Which hook would you use to access the current route in Next.js?",
      options: ["useRouter", "useRoute", "useNavigation", "usePath"],
    ...
    },
    {
      id: 10,
      question:
        "Which of the following is NOT a valid data fetching method in Next.js?",
      options: [
