              ...
              <div key={index} className="mb-12">
                ...
                <div className="prose max-w-none">
                  ...
                  <p className="mb-4">
                    ...
                    condimentum laoreet. Nunc eu ullamcorper orci. Quisque eget
                  ...
                  {index % 2 === 0 && (
                    <div className="bg-gray-100 p-4 rounded-md my-4">
                      ...
                      <p className="text-sm">
                        ...
                        information in this section. Pay attention to how the
                        left sidebar remains visible as you scroll through this
                        content.
                      </p>
                    </div>
                  )}
