  ...
  useEffect(() => {
    ...
    const texture = textureLoader.load("/android-chrome-512x512.png", () => {
      ...
      if (context && texture.image) {
        ...
        const edgePixel = context.getImageData(
    ...
    const tileGeometry = new THREE.ExtrudeGeometry(
      roundedRectShape,
      extrudeSettings,
    );
    ...
    // Add raised "</>" text on the front face
    ...
    textMesh.position.set(
      centerX,
      centerY,
      extrudeSettings.depth + extrudeSettings.bevelThickness - 0.01,
    );
